...
int InputManager::GetWheelDelta() const
{
    return m_CurMouse.wheelDelta;
}

void InputManager::SetMouseWheelDelta(int value)
{
...
{
    if (raw.data.mouse.usButtonFlags & RI_MOUSE_WHEEL) // 휠 입력이 있는 경우에만
    {
